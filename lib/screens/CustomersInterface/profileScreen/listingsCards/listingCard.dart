...
import 'package:livein/screens/CustomersInterface/profileScreen/listingsCards/listingPreview.dart';
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Listingpreview(
              title: widget.title,
              host: widget.host,
              price: widget.price,
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  ...
                  // Other elements (label, indicators, etc.)
                  // Live label
                  Positioned(
                    top: 16,
                    left: 16,
